    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://own-b2i.sentry.io/issues/?project=4509876643299328">Issues Page</a>.
